...
export default function Home() {
  return (
    <>
    <AuthProvider>
     <div className='product_description lg:w-[850px]  h-[29px]  lg:h-[168px]  text-[#252020] m-auto lg:mt-[300px]'>
            <p className='lg:font-[400] lg:text-[60px] font-simplon lg:h-[72px] text-center lg:tracking-tighter lg:leading-[72px] text-[24px] mt-40'>DISCOVER OUR PRODUCTS</p>
